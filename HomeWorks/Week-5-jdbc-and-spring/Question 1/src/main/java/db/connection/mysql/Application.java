...
private static Scanner scanner = new Scanner(System.in);
		...
		while(true) {
			...
			switch (choice) {
				...
				case 7:
					...
					managerService.loadAllActiveManagers();
					break;
				case 8:
					// burada tüm departmanları listeleyiniz.
					showAllDepartments(departmentService);
	...
	public static void showAllDepartments(DepartmentService departmentService) {
		...
		List<Department> depart =departmentService.getAllDepartments();
		
		Iterator<Department> iterator1=depart.iterator();
		while(iterator1.hasNext()) {
			Department depart1=iterator1.next();
